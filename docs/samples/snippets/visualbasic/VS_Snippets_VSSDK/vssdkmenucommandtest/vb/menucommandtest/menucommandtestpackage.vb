...
' The ProvideMenuResource attribute is needed to let the shell know that this package exposes some menus.
    ...
    Guid(GuidList.guidMenuCommandTestPkgString)> _
    Public NotInheritable Class MenuCommandTestPackage
Inherits Package
...
Protected Overrides Sub Initialize()
    ...
    If Not mcs Is Nothing Then
                ...
                Dim menuCommandID As New CommandID(GuidList.guidMenuCommandTestCmdSet, CInt(PkgCmdIDList.cmdidAddAdornment))

...
' in the Help/About dialog of Visual Studio.
    ...
    Guid(GuidList.guidVSSDKHRESULTInformationPkgString)> _
    Public NotInheritable Class VSSDKHRESULTInformationPackage
Inherits Package
...
#End Region
    ...
    Public Sub ParsnipFiller1(ByVal cmdID As Integer)
        '<Snippet1>
    ...
    Public Sub ParsnipFiller2(ByVal cmdID As Integer)
        '<Snippet2>
        Dim hr As Integer = MyInterface.MyFunction(cmdID)

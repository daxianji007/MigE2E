...
' The ProvideMenuResource attribute is needed to let the shell know that this package exposes some menus.
    ...
    Guid(GuidList.guidGetGlobalServicePkgString)> _
    Public NotInheritable Class GetGlobalServicePackage
Inherits Package
...
Protected Overrides Sub Initialize()
    ...
    If Not mcs Is Nothing Then
                ...
                Dim menuCommandID As New CommandID(GuidList.guidGetGlobalServiceCmdSet, CInt(PkgCmdIDList.cmdidMyCommand))
...
Private Sub MenuItemCallback(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(0, clsid, "GetGlobalService", String.Format(CultureInfo.CurrentCulture, "Inside {0}.MenuItemCallback()", Me.GetType().Name), String.Empty, 0, OLEMSGBUTTON.OLEMSGBUTTON_OK, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST, OLEMSGICON.OLEMSGICON_INFO, 0, result))
End Sub

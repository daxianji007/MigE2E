...
Namespace Microsoft.MyLanguagePackage
	...
	Public NotInheritable Class MyLanguagePackagePackage
		Inherits Package
		''' <summary>
		...
		Protected Overrides Sub Initialize()
			...
			If Nothing IsNot mcs Then
				...
				Dim menuCommandID As New CommandID(GuidList.guidMyLanguagePackageCmdSet, CInt(Fix(PkgCmdIDList.cmdidInsertSnippet)))
		...
		Private Sub MenuItemCallback(ByVal sender As Object, ByVal e As EventArgs)
			...
			Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(0, clsid, "MyLanguagePackage", String.Format(CultureInfo.CurrentCulture, "Inside {0}.MenuItemCallback()", Me.ToString()), String.Empty, 0, OLEMSGBUTTON.OLEMSGBUTTON_OK, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST, OLEMSGICON.OLEMSGICON_INFO, 0, result)) ' false
		End Sub

...
namespace Microsoft.VSSDKHRESULTInformation
{
    ...
    [Guid(GuidList.guidVSSDKHRESULTInformationPkgString)]
    public sealed class VSSDKHRESULTInformationPackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public VSSDKHRESULTInformationPackage()
        {

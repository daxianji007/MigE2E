...
namespace Microsoft.VSSDKAuto
{
    ...
    [Guid(GuidList.guidVSSDKAutoPkgString)]
    public sealed class VSSDKAutoPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidVSSDKAutoCmdSet, (int)PkgCmdIDList.cmdidMyCommand);

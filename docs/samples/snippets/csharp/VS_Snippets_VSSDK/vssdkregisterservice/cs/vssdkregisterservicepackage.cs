...
namespace Microsoft.VSSDKRegisterService
{
    ...
    [Guid(GuidList.guidVSSDKRegisterServicePkgString)]
    public sealed class VSSDKRegisterServicePackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public VSSDKRegisterServicePackage()
        {
    ...
    //
    // Parsnip-related code - gutted from Extensibility Samples 
    //
